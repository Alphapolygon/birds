...
export const ANIM_CATALOG: Record<number, AnimDef> = {
  ...
  [ANIM_IDS.RED_ATTACK]: { frames: ['BIRD_RED_YELL', 'BIRD_RED_FLYING'], duration: 0.2, loop: false },
  ...
  [ANIM_IDS.CHUCK_ATTACK]: { frames: ['BIRD_YELLOW_YELL', 'BIRD_YELLOW_FLYING', 'BIRD_YELLOW_SPECIAL'], duration: 0.15, loop: false },
  ...
  [ANIM_IDS.BOMB_ATTACK]: { frames: ['BIRD_GREY_YELL', 'BIRD_GREY_FLYING'], duration: 0.25, loop: false },
  [ANIM_IDS.BOMB_HIT]: { frames: ['BIRD_GREY_1', 'BIRD_GREY_2', 'BIRD_GREY_3'], duration: 0.15, loop: false },

  [ANIM_IDS.BLUES_IDLE]: { frames: ['BIRD_BLUE', 'BIRD_BLUE', 'BIRD_BLUE', 'BIRD_BLUE_BLINK'], duration: 0.4, loop: true },
  [ANIM_IDS.BLUES_ATTACK]: { frames: ['BIRD_BLUE_YELL'], duration: 0.3, loop: false },
  ...
  [ANIM_IDS.TERENCE_ATTACK]: { frames: ['BIRD_BIG_BROTHER_YELL'], duration: 0.4, loop: false },
  ...
  [ANIM_IDS.HAL_ATTACK]: { frames: ['BIRD_BOOMERANG_YELL', 'BIRD_BOOMERANG_SPECIAL', 'BIRD_BOOMERANG'], duration: 0.2, loop: false },
  ...
  [ANIM_IDS.AL_ATTACK]: { frames: ['BIRD_GREEN_YELL', 'BIRD_GREEN_FLYING', 'BIRD_GREEN_SPECIAL'], duration: 0.2, loop: false },
  ...
  [ANIM_IDS.PIG_GRUNT_HIT]: { frames: ['PIGLETTE_SMALL_02', 'PIGLETTE_SMALL_03'], duration: 0.25, loop: false },
  ...
  [ANIM_IDS.PIG_BRUISER_HIT]: { frames: ['PIGLETTE_HELMET_02', 'PIGLETTE_HELMET_03'], duration: 0.25, loop: false },

  [ANIM_IDS.PIG_BOSS_IDLE]: { frames: ['PIGLETTE_KING_01', 'PIGLETTE_KING_01', 'PIGLETTE_KING_01_BLINK'], duration: 1.0, loop: true },
  [ANIM_IDS.PIG_BOSS_ATTACK]: { frames: ['PIGLETTE_KING_07_SMILE', 'PIGLETTE_KING_08_SMILE'], duration: 0.25, loop: false },
  [ANIM_IDS.PIG_BOSS_HIT]: { frames: ['PIGLETTE_KING_02', 'PIGLETTE_KING_03'], duration: 0.3, loop: false },

  [ANIM_IDS.PIG_ARCHER_IDLE]: { frames: ['PIGLETTE_MEDIUM_01', 'PIGLETTE_MEDIUM_01', 'PIGLETTE_MEDIUM_01_BLINK'], duration: 0.8, loop: true },
  [ANIM_IDS.PIG_ARCHER_ATTACK]: { frames: ['PIGLETTE_MEDIUM_01_SMILE'], duration: 0.3, loop: false },
  [ANIM_IDS.PIG_ARCHER_HIT]: { frames: ['PIGLETTE_MEDIUM_02', 'PIGLETTE_MEDIUM_03'], duration: 0.25, loop: false },

  [ANIM_IDS.PIG_THIEF_IDLE]: { frames: ['PIGLETTE_GRANDPA_01', 'PIGLETTE_GRANDPA_01', 'PIGLETTE_GRANDPA_01_BLINK'], duration: 0.8, loop: true },
  [ANIM_IDS.PIG_THIEF_ATTACK]: { frames: ['PIGLETTE_GRANDPA_04_SMILE', 'PIGLETTE_GRANDPA_05_SMILE'], duration: 0.25, loop: false },
  [ANIM_IDS.PIG_THIEF_HIT]: { frames: ['PIGLETTE_GRANDPA_02', 'PIGLETTE_GRANDPA_03'], duration: 0.25, loop: false },
};

export function getUnitAnimation(unitId: string, state: 'idle' | 'attack' | 'hit'): number {
  switch (unitId) {
    ...
    case 'bomb':
    case 'silver': return state === 'idle' ? ANIM_IDS.BOMB_IDLE : state === 'attack' ? ANIM_IDS.BOMB_ATTACK : ANIM_IDS.BOMB_HIT;
    case 'blues':
    case 'stella': return state === 'idle' ? ANIM_IDS.BLUES_IDLE : state === 'attack' ? ANIM_IDS.BLUES_ATTACK : ANIM_IDS.BLUES_HIT;
